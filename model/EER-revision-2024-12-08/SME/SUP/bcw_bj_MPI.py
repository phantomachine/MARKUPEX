...
if rank == 0:
    ...
    model = baseline_mod(σ_DM=σ_DM, Ubar_CM=Ubar_CM, n=n, α_1=α_1,τ_max =  τ_max , τgrid_size = τgrid_size, N_reimann=N_reimann,Tol=1e-10)
    z_guess = 0.5
    i_guess = 0.01
    params = {
        'model': model,
...
if rank == 0:  # rank 0만 결과 처리 및 시각화 수행
    ...
    model_hlmw = hlmw.hlmw_mod(σ_DM=σ_DM, Ubar_CM=Ubar_CM, n=n, 
                              α_1=α_1,τ_max = τ_max, τgrid_size = τgrid_size, N_reimann=N_reimann,Tol=1e-5)
