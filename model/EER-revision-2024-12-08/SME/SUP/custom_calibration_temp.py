...
class baseline_mod(object):
    ...
    def __init__(self, 
              β = 0.9804, σ_CM = 1.0, σ_DM = 0.4225,  
                 ...
                 c = 1.0, τ_b = 0.0, τ_max = 0.14, τgrid_size = 40, 
...
model = baseline_mod(σ_DM=0.2, Ubar_CM=1.9, n=0.65, α_1=0.1)
...
plt.savefig("m1_gdp_model_fit_sigma07.png", dpi=800)
