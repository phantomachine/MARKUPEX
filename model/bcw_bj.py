...
class baseline_mod(object):
    ...
    def __init__(self, 
              β = 0.9804, σ_CM = 1.0, σ_DM = 0.4225,  
                 ...
                 N_reimann = 500, Tol=1e-12,τ_min=0.0,
                 α_1=0.3, n=0.8
                ):
        #Model parameters
...
#            print("💩 You have a problem with your cutoff ordering!")
    ...
    def money_euler_rhs(self, z, i, τ):
        ...
        if τ > self.β - 1.0:
            ...
            deposit_premium = np.array( [ i for ρ in ρ_grid[ρ_hat_index:]] )
            
            mu_depositor_1 = (1-self.n) * i 
            
            mu_depositor_2 = em_deposit * deposit_premium * dF_grid[ρ_hat_index:]
...
model = baseline_mod(σ_DM=σ_DM, Ubar_CM=Ubar_CM, n=n,τ_max = 0.00,α_1=α_1,τgrid_size = 10,N_reimann = 300,Tol=1e-10)
